...
Config.Environment = {
    ...
    Seasons = {
        spring = {
            ...
            floodRisk = 0.2,
            cropBonus = 0.15,
            pastureRegrowth = 0.25
        },
        summer = {
            temperature = { min = 75, max = 105 },
    ...
    Hazards = {
        lightning = {
            ignitionChance = 0.1,
            barnFireDamage = 0.25,
            notification = "Lightning storm! Secure the barns.",
            randomChance = 0.08
        },
        flood = {
            livestockRisk = 0.2,
            cropDamage = 0.35,
            debrisSpawn = true,
            notification = "Floodwaters rising—move stock to high ground!",
            randomChance = 0.05
        },
        drought = {
            pasturePenalty = 0.5,
            milkYieldPenalty = 0.3,
            waterConsumptionBonus = 0.4,
            notification = "Drought settling in. Ration water supplies.",
            randomChance = 0.06
        },
        blizzard = {
            feedDemand = 0.5,
            ...
            notification = "Blizzard inbound! Shelter animals immediately.",
            randomChance = 0.04
        },
        duststorm = {
            suffocationRisk = 0.35,
            buildingDamage = 0.1,
            notification = "Dust storm approaching—cover troughs and bring stock inside!",
            randomChance = 0.05
        }
    },
    Wildlife = {
...
Config.Livestock = {
    ...
    Species = {
        cattle = {
            label = "Cattle",
            gestationDays = 9,
            yields = { milk = 6, beef = 4, manure = 5 },
            preferredPasture = "grass",
            genetics = { milkYield = { 0.8, 1.2 }, coatColor = { "black", "brown", "speckled" } },
            diseases = { "hoof_rot", "pox", "parasites" },
            temperament = { base = 0.6, aggression = 0.3 },
            housing = "barn"
        },
        horses = {
            label = "Horse",
            gestationDays = 11,
            yields = { stamina = 1, haul = 1 },
            preferredPasture = "mixed",
            genetics = { speed = { 0.85, 1.15 }, temperament = { "calm", "fiery", "bold", "stubborn" } },
            diseases = { "colic", "ticks" },
            temperament = { base = 0.5, aggression = 0.4 },
            housing = "stable",
            training = { groundwork = true, riding = true, pulling = true }
        },
        sheep = {
            label = "Sheep",
            gestationDays = 5,
            yields = { wool = 8, manure = 2 },
            preferredPasture = "clover",
            genetics = { woolQuality = { 0.9, 1.3 }, color = { "white", "black", "brown" } },
            diseases = { "parasites", "pox" },
            temperament = { base = 0.7, aggression = 0.1 },
            housing = "shearing_shed"
        },
        goats = {
            label = "Goat",
            gestationDays = 5,
            yields = { milk = 4, meat = 2 },
            preferredPasture = "brush",
            genetics = { milkFat = { 0.9, 1.3 } },
            diseases = { "ticks", "parasites" },
            temperament = { base = 0.65, aggression = 0.2 },
            housing = "goat_pen"
        },
        pigs = {
            label = "Pig",
            gestationDays = 4,
            yields = { meat = 8, fat = 6 },
            preferredPasture = "mud",
            genetics = { marbling = { 0.8, 1.4 } },
            diseases = { "pox", "parasites" },
            temperament = { base = 0.4, aggression = 0.35 },
            housing = "pig_pen"
        },
        chickens = {
            label = "Chicken",
            gestationDays = 1,
            yields = { eggs = 12, feathers = 6 },
            preferredPasture = "yard",
            genetics = { eggYield = { 0.7, 1.5 }, color = { "white", "brown", "speckled" } },
            diseases = { "pox" },
            temperament = { base = 0.8, aggression = 0.05 },
            housing = "coop"
        },
        ducks = {
            label = "Duck",
            gestationDays = 1,
            yields = { eggs = 8, down = 5 },
            preferredPasture = "pond",
            genetics = { eggWeight = { 0.8, 1.4 } },
            diseases = { "parasites" },
            temperament = { base = 0.75, aggression = 0.08 },
            housing = "pond"
        },
        turkeys = {
            label = "Turkey",
            gestationDays = 1,
            yields = { meat = 6, feathers = 7 },
            preferredPasture = "orchard",
            genetics = { size = { 0.9, 1.4 } },
            diseases = { "pox" },
            temperament = { base = 0.55, aggression = 0.25 },
            housing = "yard"
        },
        dogs = {
            label = "Dog",
            ...
            yields = { loyalty = 1 },
            preferredPasture = "yard",
            genetics = { loyalty = { 0.8, 1.4 } },
            diseases = { "ticks" },
            temperament = { base = 0.9, aggression = 0.2 },
            housing = "kennel"
        },
        cats = {
            label = "Cat",
            gestationDays = 2,
            yields = { pestControl = 1 },
            preferredPasture = "barn",
            genetics = { hunting = { 0.9, 1.5 } },
            diseases = { "parasites" },
            temperament = { base = 0.85, aggression = 0.15 },
            housing = "barn"
        },
        alpaca = {
            label = "Alpaca",
            gestationDays = 7,
            yields = { fiber = 5 },
            preferredPasture = "highland",
            genetics = { fiberLength = { 1.0, 1.4 } },
            diseases = { "parasites" },
            temperament = { base = 0.7, aggression = 0.12 },
            housing = "shearing_shed"
        },
        bees = {
            label = "Bee Colony",
            gestationDays = 0,
            yields = { honey = 10, wax = 4 },
            preferredPasture = "orchard",
            genetics = { productivity = { 0.8, 1.6 } },
            diseases = { "mites" },
            temperament = { base = 0.4, aggression = 0.6 },
            housing = "apiary"
        },
        rabbits = {
            label = "Rabbit",
            gestationDays = 1,
            yields = { fur = 6, meat = 3 },
            preferredPasture = "burrow",
            genetics = { litterSize = { 0.9, 1.5 } },
            diseases = { "parasites" },
            temperament = { base = 0.7, aggression = 0.1 },
            housing = "hutch"
        }
...
Config.ProductionChains = {
    Dairy = {
        milkYieldMultiplier = 1.0,
        butterAgingMinutes = 30,
        cheeseAgingHours = 24,
    ...
    Meat = {
        primeCutBonus = 0.2,
        spoilageChance = 0.15,
        wasteToByproduct = 0.4
    },
    Poultry = {
        incubatorDurationHours = 24,
        eggGradingQuality = { A = 0.9, B = 0.7, C = 0.5 }
    },
    Fiber = {
        washingLoss = 0.1,
        dyeingOptions = { "indigo", "madder", "walnut" },
        yarnQualityMultiplier = 1.2
    },
    Byproducts = {
...
Config.Hazards = {
    ...
    CommunityEvents = {
        rodeo = { frequencyHours = 72, moraleBonus = 0.1 },
